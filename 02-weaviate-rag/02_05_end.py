...
with weaviate.connect_to_weaviate_cloud(
    ...
    #3. Use the agent in a conversation
    # The Query Agent can also remember the context of a conversation. You can use it in `search` mode, `ask` mode, or a combination of both.
